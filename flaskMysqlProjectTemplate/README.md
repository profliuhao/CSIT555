...
Open your web browser and go to the GitHub repository URL: https://github.com/profliuhao/CSIT555/tree/main/flaskMysqlProjectTemplate.
...
```shell
cd path/to/CSIT555-main/flaskMysqlProjectTemplate
```
...
```sql
CREATE USER 'haoliu'@'' IDENTIFIED WITH mysql_native_password BY 'csit555_root';
...
-- ALTER USER 'haoliu'@'' IDENTIFIED WITH mysql_native_password BY 'csit555_root2';
```
